...
;function Time(){
  var theTimeIMetU = new Date(2013, 7, 22, 14, 0, 0, 0);
  var now = Date.now();
...
;function Time(){
  ...
  timeDom.innerHTML = '<div id="clock"><span class="digit">' + days + '</span><span class="unit">days</span><span class="digit">' + hours + '</span><span class="unit">hrs</span><span class="digit">' + minutes + '</span><span class="unit">mins</span><span class="digit">' + seconds + '</span><span class="unit">secs</span></div>'
}
