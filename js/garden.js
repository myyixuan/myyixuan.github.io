...
//   var now = Date.now();
//   var t = now - theTimeIMetU;
//   var day_dom = document.getElementById('timeDays');
//   var hour_dom = document.getElementById('timeHrs');
//   var min_dom = document.getElementById('timeMins');
//   var sec_dom = document.getElementById('timeSecs');

//   if (day_dom) {
//     day_dom.innerHTML = ~~(t / (24 * 3600 * 1000));
//   }
//   if (hour_dom) {
//     hour_dom.innerHTML = ~~((t % (24 * 3600 * 1000)) / (3600 * 1000));
//   }
//   if (min_dom) {
//     min_dom.innerHTML = ~~((t % (3600 * 1000)) / (60 * 1000));
//   }
//   if (sec_dom) {
//     sec_dom.innerHTML = ~~((t % (60 * 1000)) / 1000);
//   }
// }
